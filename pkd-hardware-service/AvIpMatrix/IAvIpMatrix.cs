namespace pkd_hardware_service.AvIpMatrix
{
	...
	{
		/// <summary>
		/// Triggered when an endcoder or decoder status changes, typcially used for online/offline events.
		/// </summary>
		...
		/// </summary>
		/// <param name="deviceId">The unque ID of the endpoint to request.</param>
		...
		/// <param name="endpointType">Define whether or not this will be added as an encoder or decoder endpoint.</param>
		void AddEndpoint(
			string id,
			List<string> tags,
			int ioIndex,
